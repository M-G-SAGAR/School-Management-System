            ...
            <main class="p-6 bg-gray-50 m-4 rounded-xl shadow-md">
               ...
               <%--  <h2 class="text-1xl font-bold text-blue-800 mb-2">${student.firstName} ${student.lastName}</h2> --%>
                     ...
                     <%-- <h2 class="text-1xl font-bold text-blue-800 mb-6">Details - ${classes.firstName} ${classes.lastName}</h2>
                        ...
                        <%-- <h2 class="text-1xl font-bold text-blue-800 mb-6">Class Details - ${subject.subjectCode} ${teacher.secondName}</h2>
                    ...
                    <div class="flex-1">
                       ...
                       <!--  <p class="text-gray-600">Student ID: <strong>STUDENT#${student.id}</strong></p> -->
                        ...
                        <div class="mt-4 ml-4 space-y-6">
                            <div>
                                <h3 class="text-xl font-semibold text-blue-700 border-b-1 border-blue-500 pb-1 mb-2">Notice Information</h3>
                                <ul class="space-y-2 text-gray-700">
                                    <li><strong>Title:</strong> NOTICE#${notice.title}</li>
                                    <li><strong>Posted By:</strong> ${notice.postedBy}</li>
                            ...
                            <div>
                                <h3 class="text-xl font-semibold text-blue-700 border-b-1 border-blue-500 pb-1 mb-2">Description Information</h3>
                                <ul class="space-y-2 text-gray-700">
                                    <%-- <li><strong>Gender:</strong> ${subjects.subjectType}</li> --%>
                                   <%--  <li><strong>Subject Type:</strong> ${subjects.subjectType}</li> --%>
                                    <li><strong>Details:</strong> ${notice.details}</li>
                                </ul>
                            </div>

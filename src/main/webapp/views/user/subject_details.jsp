...
<body class="bg-gray-100">
 ...
 -->                <div class="flex items-center space-x-4">
                    <span>Hi! ${subjects.subjectCode}</span>
                        ...
                        <div class="mt-4 ml-4 space-y-6">
                            <div>
                                ...
                                <ul class="space-y-2 text-gray-700">
                                    <li><strong>Subject Code:</strong> SUBJECT#${subjects.subjectCode}</li>
                                    <li><strong>Subject Name:</strong> ${subjects.subjectName}</li>
                            ...
                            <div>
                                ...
                                <ul class="space-y-2 text-gray-700">
                                    ...
                                    <li><strong>Class:</strong> ${subjects.className}</li>
                                </ul>
                            </div>

   ...
   <!--  End SideBar -->
    ...
    <div class="content">
        ...
        <c:if test="${not empty sessionScope.message}">
            ...
            <h3>Update Class</h3>
			<form action="/user/class-update/${classes.id }" method="post" object="${classes }" class="user" enctype="multipart/form-data">
            <h4>Class Information</h4>
            <div class="form-section">
                <div class="form-group">
                    <label>Teacher Name</label>
                    <input type="text" name="teacher_Name" value="${classes.teacher_Name }">
                </div>
                <div class="form-group">
                    <label>Teacher ID</label>
                    <input type="text" name="tid" value="${classes.tid }">
                </div>
                <div class="form-group">
                    <label>Class</label>
                    <select name="class_Name" value="${classes.class_Name }">
                ...
                <div class="form-group">
                    <label>Subject</label>
                    <select name="subject" value="${classes.subject }">
                ...
                <div class="form-group">
                    <label>Gender</label>
                    <select name="gender" value="${classes.gender }">
                ...
                <div class="form-group">
                    <label>Date</label>
                    <input type="date" name="date" value="${classes.date }">
                </div>
                <div class="form-group">
                    <label>Time</label>
                    <input type="time" name="time" value="${classes.time }">
                </div>
               <div class="form-group">
                    <label>Section</label>
                     <select name="section" value="${classes.section }">
                ...
                <div class="form-group">
                    <label>Email</label>
                    <input type="email" name="email" value="${classes.email }">
                </div>
                <!-- <div class="form-group">
                ...
                <div class="form-group">
                    <label>Phone</label>
                    <input type="text" name="phone" value="${classes.phone }">
                </div>
                <!-- <div class="form-group">
                    <label>Subject</label>
                     <select name="subject">

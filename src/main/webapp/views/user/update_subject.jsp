...
<head>
    ...
    <title>Subject Admit Form</title>
    <style>
        body {
   ...
   <!--  End SideBar -->
    ...
    <div class="content">
        ...
        <c:if test="${not empty sessionScope.message}">
			...
			<form action="/user/subject-update/${subjects.subjectCode }" method="post" object="${subjects }" class="user" >
            <h4>Subject Information</h4>
            <div class="form-section">
                <div class="form-group">
                    <label>Subject Code</label>
                    <input type="text" name="subjectCode" value="${subjects.subjectCode }">
                </div>
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                    <label>Subject</label>
                     <select name="subjectName" value="${subjects.subjectName }">
                ...
                <div class="form-group">
                    <label>Class</label>
                    <select name="className" value="${subjects.className }">
                ...
                <div class="form-group">
                    ...
                    <select name="subjectType" value="${subjects.subjectType }">
